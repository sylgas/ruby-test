class ConnectionsController < ApplicationController
  ...
  def show
    @connection = Connection.where("initperson_id = #{params[:id]} OR answerperson_id = #{params[:id]}");
  end
  ...
  private
    ...
    def connection_params
      params.require(:connection).permit(:initperson_id, :answerperson_id, :duration, :cdate)
    end
end
