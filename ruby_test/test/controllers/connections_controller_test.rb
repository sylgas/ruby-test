...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { answerperson: @connection.answerperson, cdate: @connection.cdate, duration: @connection.duration, initperson: @connection.initperson }
    end
  ...
  test "should update connection" do
    patch :update, id: @connection, connection: { answerperson: @connection.answerperson, cdate: @connection.cdate, duration: @connection.duration, initperson: @connection.initperson }
    assert_redirected_to connection_path(assigns(:connection))
  end
